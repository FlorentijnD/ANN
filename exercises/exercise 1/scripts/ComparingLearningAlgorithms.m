...
%% Bar Plot Test RMSE
% returning a barplot for the RMSE Test Error names = categorical(training_algs);
barplot = bar(names, rmse_test); title("Influence of the number of hidden neurons on test error"); ylabel("RMSE per input");
legend_bar = legend(barplot,{"1", "5", "20", "50", "200"});
title(legend_bar, "Amount of hidden neurons");
ylim([0 0.3]);
